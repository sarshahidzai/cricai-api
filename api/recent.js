...
export default async function handler(req, res) {
  ...
  // CricAPI doesn't have a dedicated "recent" endpoint in v1,
  // so we call /matches and let the client decide how to slice/filter.
  const result = await callCricApi("/matches");
  sendJson(res, result);
}
